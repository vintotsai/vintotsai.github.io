...
var FERD_NavNotice = {
	...
	getNewsList : function(_hour,_day){
		...
		if(sum == 0||(!isToday)){
			_this.getScript("http://i.match.qq.com/notice/browser?action=getAll&ch="+_this.site+"&type=1&is_list=1&num=20&callback=window.FERD_UserData");
		}else{
...
FERD_NavNotice.init();/*  |xGv00|7b100ce9e5c3d70c0726a258df107029 */